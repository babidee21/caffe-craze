...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/shop-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:28 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Shop</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
            ...
            <div class="container-fluid">
                <div class="shop-grid-topbar-container mb-16">
                    <div class="shop-grid-topbar v-2 mb-12 p-0">
                        <div class="first-block">
                            <div class="visual-btns">
                                ...
                                <a href="shop-grid.php" class="visual-box active">
                                ...
                                <a href="shop-list-sidebar.php" class="visual-box">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="results d-xl-block d-none">
                                <p class="color-white fw-300">Showing 01 - 09 of 30 Results</p>
                            </div>
                        </div>
                        
                        <div class="last-block">
                            <div class="d-lg-flex d-none align-items-center gap-8">
                                <p class="color-white">Short by:</p>
                                <div class="drop-container ">
                                    <div class="wrapper-dropdown color-white" id="dropdown12">
                                        ...
                                        <ul class="topbar-dropdown bg-light-gray">
                                            <li class="item color-white">Price: low to high</li>
                                            <li class="item color-white">Price: high to low</li>
                                            <li class="item color-white">Price: Average Rating</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="drop-container ">
                                <div class="wrapper-dropdown dark-black" id="dropdown21">
                                    <span class="selected-display color-white" id="destination21">Show: 9</span>
                                    ...
                                    <ul class="topbar-dropdown bg-light-gray">
                                        <li class="item color-white">Show: 9</li>
                                        <li class="item color-white">Show: 5</li>
                                        <li class="item color-white">Show: 4</li>
                                        <li class="item color-white">Show: 3</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="shop-grid-bottombar">
                        <p class="color-white fw-300">Selected filters:</p>
                ...
                <div class="row row-gap-4">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-5.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="wishlist.php">
                                        <i class="far fa-heart"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-6.png" alt="">
                                </a>
                                <div class="sale">
                                    <p class="text-16 color-sec">SALE</p>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-7.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="#">
                                        <i class="far fa-heart"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-8.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="wishlist.php">
                                        <i class="far fa-heart"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-9.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="wishlist.php">
                                        <i class="far fa-heart"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-10.png" alt="">
                                </a>
                                <div class="sale">
                                    <p class="text-16 color-sec">SALE</p>
                                </div>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-11.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="#">
                                        <i class="far fa-heart"></i>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="special-item p-24">
                            <div class="item-image">
                                <a href="#">
                                    <img src="assets/media/menu/product-12.png" alt="">
                                </a>
                                <div class="icon">
                                    <a href="wishlist.php">
                                        <i class="far fa-heart"></i>
    ...
    <!-- Modal -->
     ...
     <!-- Filter Sidebar -->
     <div class="sidebar toggle-sidebar bg-dark-black">
        <div class="filter-block box-1 mb-24">
            <div class="title mb-24" data-count="1">
                <h5 class="color-white">Categories</h5>
                <span>
            ...
            <div class="content-block">
                <ul class="list-unstyled">
                    <li class="d-flex align-items-center justify-content-between mb-12">
                        <a href="blog-list-sidebar.php" class="color-white fw-400">Coffee</a>
                        <p class="color-white fw-400">(12)</p>
                    </li>
                    
                    <li class="d-flex align-items-center justify-content-between mb-12">
                        <a href="blog-list-sidebar.php" class="color-white fw-400">Pastries</a>
                        <p class="color-white fw-400">(04)</p>
                    </li>
                    
                    <li class="d-flex align-items-center justify-content-between">
                        <a href="blog-list-sidebar.php" class="color-white fw-400">Tea</a>
                        <p class="color-white fw-400">(08)</p>
                    </li>
                </ul>
        ...
        <div class="hr-line mb-24"></div>
        <div class="filter-block box-2 mb-24">
            <div class="title mb-24" data-count="2">
                <h5 class="color-white">Latest Products</h5>
                <span>
                    <i class="far fa-horizontal-rule"></i>
                </span>
            </div>
            <div class="content-block">
                <a href="shop-list-1.php" class="d-flex gap-16 align-items-center mb-16">
                    <div class="image-box d-flex flex-shrink-0"> 
                        <img src="assets/media/images/product-sidebar-1.png" alt="" class="br-5">
                    </div>  
                    <div>
                        <div class="rating mb-4p">
                        ...
                        <h6 class="color-white mb-8">Iced Caramel Latte</h6>
                        <p class="color-sec">$18.00</p>
                    </div>
                </a>
                <a href="shop-list-1.php" class="d-flex gap-16 align-items-center mb-16">
                    <div class="image-box d-flex flex-shrink-0"> 
                        <img src="assets/media/images/product-sidebar-2.png" alt="" class="br-5">
                    </div>  
                    <div>
                        <div class="rating mb-4p">
                            <i class="fa-solid fa-star-sharp color-sec"></i>
                        ...
                        <p class="color-white mb-8">White Chocolate Mocha</p>
                        <p class="color-sec">$18.00</p>
                    </div>
                </a>
                <a href="shop-list-1.php" class="d-flex gap-16 align-items-center">
                    <div class="image-box d-flex flex-shrink-0"> 
                        <img src="assets/media/images/product-sidebar-2.png" alt="" class="br-5">
                    </div>  
                    <div>
                        ...
                        <p class="color-white mb-8">Cappuccino</p>
                        <p class="color-sec">$18.00</p>
                    </div>
                </a>
            </div>
        ...
        <div class="hr-line mb-24"></div>
        <div class="filter-block box-3 mb-24">
            <div class="title mb-32" data-count="3">
                <h5 class="color-white">Price Range</h5>
                <span>
                    <i class="far fa-horizontal-rule"></i>
                </span>
            </div>
        ...
        <div class="filter-block box-4 mb-24">
            ...
            <div class="content-block">
                <div class="blog-tags-wrapper">
                    <a href="blog-list-sidebar.php" class="blog-tags fw-300 lightest-gray">
                        Coffee
                    </a>
                    <a href="blog-list-sidebar.php" class="blog-tags fw-300 lightest-gray">
                        Tea
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/shop-grid.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:30 GMT -->
</html>