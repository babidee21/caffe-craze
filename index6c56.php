...
// dito ung isset walang ! it means if meron reredirect ka sa index.php
//index6c56 is landing page para sa mga d naka log in
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/?fbclid=IwY2xjawFHgutleHRuA2FlbQIxMAABHSfV1Iu8woWi-Qy2DJT8M-Milyt77AfOzPnl9w9aOa5P1YbW8ln981rJBQ_aem_l0Yg6PA7IBAFso_rg42E7Q by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:15:39 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="navigation-wrapper">
                        ...
                        <div class="main-menu__nav">
                            <ul class="main-menu__list">
                                <li class="active">
                                    <a href="index6c56.php" class="active">Home</a>
                                </li>
                                <li>
                        ...
                        <div class="header-right-block">
                            ...
                            <a href="#" class="d-lg-block d-none icon transparent-button">
                                <i class="fa-regular fa-heart"></i>
                            </a>
                            <a href="#" class="d-lg-block d-none icon transparent-button">
                                <i class="fa-regular fa-cart-shopping"></i>
                            </a>
                            <a href="#" class="cus-btn primary text-16">
                                BOOK A TABLE
                            </a>
        ...
        <section class="hero-banner">
            <div class="hero-slider">
                <div class="slider-block slide-1">
                    <div class="detail">
                        <div class="mb-48">
                            <h2 class="h1 fw-400 color-white mb-16">Welcome All You Need To Feel Better is Cup of Coffee </h2>
                            <!-- All You Need To Feel Better is Cup of Coffee -->
                ...
                <div class="slider-block slide-2">
                    <div class="detail">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-24">
                            ...
                            <a href="#" class="cus-btn transparent text-16">
                                CONTACT US
                            </a>
                        </div>
                    </div>
                ...
                <div class="row row-gap-4">
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="member-detail p-24 d-flex flex-column align-items-center gap-16 text-center">
                                <a href="#" class="h5 color-white">Sarah Johnson</a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="member-detail p-24 d-flex flex-column align-items-center gap-16 text-center">
                                <a href="#" class="h5 color-white">Ethan Rodriguez</a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="member-detail p-24 d-flex flex-column align-items-center gap-16 text-center">
                                <a href="#" class="h5 color-white">Emily Brooks</a>
                                <p class="color-white">Maker</p>
                                <div class="social">
                                    <div class="social-link">
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-lg-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="member-detail p-24 d-flex flex-column align-items-center gap-16 text-center">
                                <a href="#" class="h5 color-white">Megan Robinson</a>
                                <p class="color-white">Waiter</p>
                                <div class="social">
                                    <div class="social-link">
                                        <a href="#">
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-12 color-white"><a href="./shop-grid-sidebar.php">Shop</a></li>
                        </ul>
                    </div>
                    <div class="footer-link-box v-2">
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/?fbclid=IwY2xjawFHgutleHRuA2FlbQIxMAABHSfV1Iu8woWi-Qy2DJT8M-Milyt77AfOzPnl9w9aOa5P1YbW8ln981rJBQ_aem_l0Yg6PA7IBAFso_rg42E7Q by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:07 GMT -->
</html>