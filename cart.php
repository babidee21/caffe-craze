...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:34 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Cart</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-8">
                                    ...
                                    <tr class="table-row">
                                        <td class="pd">
                                            <div class="product-detail-box">
                                                ...
                                                <a href="#" class="h5"><i class="fal fa-times color-white"></i></a>
                                                <div class="img-block">
                                                    <a href="shop-grid.php"><img src="assets/media/images/cart-image-1.png" alt="" class="br-5"></a>
                                                </div>
                                                <div class="d-block text-start">
                                                    <h6 class="color-white"><a href="shop-grid.php">Caramel Cappuccino</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <h6 class="color-white fw-500">$18.00</h6>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="table-row">
                                        <td class="pd">
                                            <div class="product-detail-box">
                                                ...
                                                <a href="#" class="h5"><i class="fal fa-times color-white"></i></a>
                                                <div class="img-block">
                                                    <a href="shop-grid.php"><img src="assets/media/images/cart-image-2.png" alt="" class="br-5"></a>
                                                </div>
                                                <div class="d-block text-start">
                                                    <h6 class="color-white"><a href="shop-grid.php">Iced Caramel Latte</a></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                        ...
                        <div class="d-lg-none d-block">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cart-item-block mb-32">
                                        <div class="img-block mb-16">
                                            <a href="product-detail-1.php"><img src="assets/media/images/cart-image-1.png" alt="" class="br-5"></a>
                                            <a href="#" class="cross"><i class="fal fa-times"></i></a>
                                        </div>
                                        <h6 class="color-white fw-500 mb-24">Caramel Cappuccino</h6>
                                        <ul class="unstyled detail">
                                            <li>
                                                <h6 class="color-white">Price</h6>
                                                <h6 class="color-white">$80.00</h6>
                                            </li>
                                            <li>
                                                <p class="color-white fw-300">Date Added</p>
                                                <p class="color-white fw-300">29 Jun, 2024</p>
                                            </li>
                                            <li>
                                                <p class="color-sec">Stock Status</p>
                                                <p class="color-sec">In-Stock</p>
                                            </li>
                                            <li>
                                                <h6 class="color-white">Quantity</h6>
                                                <div class="quantity-controller quantity-wrap">
                                                    <input class="decrement" type="button" value="-">
                                                    <input type="text" name="quantity" value="1" maxlength="2" size="1"
                                                        class="number">
                                            ...
                                            <li>
                                                <a href="cart.php" class="cus-btn transparent">Add to Cart</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="cart-item-block mb-32">
                                        <div class="img-block mb-16">
                                            <a href="product-detail-1.php"><img src="assets/media/images/cart-image-2.png" alt="" class="br-5"></a>
                                            <a href="#" class="cross"><i class="fal fa-times"></i></a>
                                        </div>
                                        <h6 class="color-white fw-500 mb-24">Iced Caramel Latte</h6>
                                        <ul class="unstyled detail">
                                            <li>
                                                <h6 class="color-white">Price</h6>
                                                <h6 class="color-white">$70.00</h6>
                                            </li>
                                            <li>
                                                <p class="color-white fw-300">Date Added</p>
                                                <p class="color-white fw-300">29 Jun, 2024</p>
                        ...
                        <div class="table-bottom-row bg-dark-black">
                            <a href="shop-list-1.php" class="cus-btn primary">Continue Shopping</a>
                            <form action="https://uiparadox.co.uk/templates/caffe-craze/checkout.php" method="post" class="contact-form d-flex align-items-center gap-16">
                                <input type="text" class="form-control" placeholder="Coupon Code" name="code" id="cpCode">
                                <button type="submit" class="cus-btn primary">Apply Now</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-xl-4">
                        <div class="checkout-box mt-xl-0 mt-48">
                            <div class="checkout-title text-center mb-16">
                                <h5 class="color-white font-primary mb-24">Cart Total</h5>
                            </div>
                            <div class="bottom-box">
                                <div class="title-price mb-16">
                                    <h6 class="color-white">Subtotal</h6>
                                    <h6 class="color-white">$80.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="title-price mb-16">
                                    <h6 class="color-white">Standard Delivery</h6>
                                    <h6 class="color-white">$5.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="title-price mb-16">
                                    <h6 class="color-white">Coupon Discount</h6>
                                    <h6 class="color-white">$-5.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-80"></div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="title-price mb-16">
                                    <h5 class="color-sec fw-500">TOTAL</h5>
                                    <h5 class="color-sec fw-500">$80.00</h5>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="text-end">
                                    <a href="checkout.php" class="cus-btn primary">PROCEED TO CHECKOUT</a>
                                </div>
                            </div>
                        </div>
                    </div>
