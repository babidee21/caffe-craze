...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/product-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:31 GMT -->
<head>
    <meta charset="UTF-8">
...
label {
    font-weight: bold;
    color: #cf8048; /* Dark brown for labels */
}
...
input[type="text"], textarea {
    ...
    border-radius: 4px;
    background-color: #fff8e1; /* Light yellow-brown background */
...
input[readonly] {
    background-color: #D2B48C; /* Brown background for readonly input */
    color: #fff;
}
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Product Detail</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
                    ...
                    <div class="row row-gap-3">
                        ...
                        <div class="col-xxl-6 col-xl-7">
                            <div class="product-main-wrapper">
                                <div class="product-slider bg-dark-black br-10">
                                    <?php
                                    include 'connect.php';
                                     //product "id"
                                    if (isset($_GET['id']) && is_numeric($_GET['id'])) {
                                        ...
                                        $sql = "SELECT * FROM drinkandpastry WHERE id = $ProductID";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            $img_name = 'uploads/' . $row['img_name'];
                                                                                
                                            $productID = $_GET['id']; 

                                            // Query to fetch average rating for the product
                                            $averageRating = round(mysqli_fetch_assoc(mysqli_query($conn, "SELECT AVG(rating) 
                                            AS average_rating FROM ratings WHERE product_id = $productID"))['average_rating'], 1);

                                            // Calculate the number of stars
                                            $stars = round($averageRating); // Round the average rating to the nearest integer
                                    ...
                                    <div class="detail-image" style="display: flex; justify-content: center; align-items: center; height:450px;">
                                    <img src="<?php echo $img_name; ?>" alt="<?php echo $ProductName; ?>" style="width: 350px; height: 500px; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-6 col-xl-5">
                            ...
                            <?php if (!empty($ProductName)): ?>
                                    <h3 class="lightest-gray font-primary fw-600 mb-12"><?php echo $ProductName; ?></h3>
                                <?php else: ?>
                                    <h3 class="lightest-gray font-primary fw-600 mb-12">Product Name Not Available</h3>
                                <?php endif; ?>
 
                                <h6 class="color-sec mb-12">
                                    <?php 
                                    if (isset($stars) && $stars >= 1 && $stars <= 5) {
                                        for ($i = 1; $i <= 5; $i++) {
                                            if ($i <= $stars) {
                                                echo "★";  
                                            } else {
                                ...
                                <!-- Description -->
                                <p class="color-white fw-300 mb-32">
                                    <?php 
                                ...
                                <div class="function-bar mb-32">
                                    <div class="d-flex align-items-center gap-16">
                                        <p class="color-white">Quantity:</p>
                                    ...
                                    <a href="cart.php" class="cus-btn transparent textd-16">
                                        ADD TO CART
                                        <i class="far fa-shopping-cart"></i>
                                    </a>

                                    <a href="checkout.php" class="cus-btn primary">
                                        BUY NOW
                                        <i class="fa-sharp fa-light fa-bag-shopping font-awos"></i>
                                    </a>
                                </div>
                                ...
                                <div class="d-flex align-items-center gap-16 mb-24">
                                    <p class="color-white">Share Product:</p>
                        ...
                        <div class="description-wrapper br-20">
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <?php else: ?>
                                    <h3 class="lightest-gray font-primary fw-600 mb-12">Product Name Not Available</h3>
                                <?php endif; ?>
                                    <p class="color-white fw-300 mb-12">
                                        ...
                                        tortor amet volutpat scelerisque. Vitae nulla euismod sed nam nulla fermentum well adipiscing velit pellentesque libero
                                        suspendisse vitae. Fringilla nisi massa gravida mi posuere vestibulum at. Sem nisl in odio dictum.
                                    </p>
                                    <p class="color-white fw-300 mb-32">
                                        Lorem ipsum dolor sit amet consectetur. Molestie cras volutpat fringilla pellentesque lobortis tempor id. Purus dolor in
                                        augue habitant. Natoque ornare proin egestas porttitor sed. Nunc egestas est augue cursus ac tincidunt dui. Nunc enim
                                ...
                                <div class="tab-pane fade show active" id="nav-review" role="tabpanel"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <h5 class="color-white mb-32">Reviews</h5>
                                            <?php
                                            include "connect.php";
                                            
                                            $sql = "SELECT * FROM comments ORDER BY date DESC"; // Fetch comments ordered by date
                                            $result = mysqli_query($conn, $sql);                // DESC = DESCENDING
                                            ?>
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<div class='review-block mb-24'>";
                                                    echo "<div class='text-box'>";
                                                    echo "<div><p class='color-sec fw-300 text-thin mb-4p'>By: " . htmlspecialchars($row['username']) . "</p>";
                                                    echo "<p class='color-sec fw-300'>" . $row['date'] . "</p></div>";
                                                    echo "<p class='light-gray mb-16'>" .(htmlspecialchars($row['message'])) . "</p>";
                                                    echo "</div></div>";
                                                }
                                            } else {
                                            ...
                                            <?php else: //need ng specific product id para malaman mo which product cinomment mo?>
                                                <p class="error">Product ID not available</p>
                                            <?php endif; ?>

                                            <label for="username">Username:</label><br>
                                            <!-- didisplay ung name mo matic ex: jeremiah -->
                                            <input type="text" id="username" name="username" 
                                                value="<?php echo isset($_SESSION['FirstName']) ? $_SESSION['FirstName'] : ''; ?>" 
                                                <?php echo isset($_SESSION['FirstName']) ? 'readonly' : ''; ?>>
                                            <br><br>

                                            <label for="message">Comment:</label><br>
                                            <textarea id="message" name="message" rows="5" required></textarea><br><br>                        
                                            <button type="submit" class="cus-btn primary text-uppercase">Submit Comment</button>
                                        </form>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="special py-80">
            <div class="container-fluid">
                <div class="d-flex flex-column align-items-center gap-8 text-center mb-48">
                    <h2 class="color-white font-primary fw-600">Related Products</h2>
                </div> 
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/product-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:33 GMT -->
</html>