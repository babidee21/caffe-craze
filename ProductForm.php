      ...
      <div class="container-fluid">
          ...
          <nav class="navigation">
              <div class="navigation-wrapper">
                  <a href="index6c56.php" class="d-flex align-items-center">
...
<section class="title-banner text-center">
    <div class="container-fluid">
        <h1 class="color-white fw-400">Add Product</h1>
    </div>
</section>
...
<div class="account">
  <form action="./insert.drink&pastry.php" method="POST" enctype="multipart/form-data" class="customer-container">
    <div class="customer-wrapper">

      <input type="text" id="ProductName" name="ProductName" placeholder="Enter product name" required 
             style="padding: 10px; width: 100%; border-radius: 8px; border: 1px solid #EAEAEC; background-color: #222; color: #FAFAFA; margin-bottom: 20px;">


      <input type="number" id="Price" name="Price" placeholder="Enter price" required 
             style="padding: 10px; width: 100%; border-radius: 8px; border: 1px solid #EAEAEC; background-color: #222; color: #FAFAFA; margin-bottom: 20px;">

      <textarea id="Description" name="Description" placeholder="Enter description" rows="4" required 
                style="padding: 10px; width: 100%; border-radius: 8px; border: 1px solid #EAEAEC; background-color: #222; color: #FAFAFA; margin-bottom: 20px;"></textarea>
   
                <div class="file-upload-container" style="margin-bottom: 20px;">
  
  <label for="fileToUpload" 
         style="padding: 10px; width: 100%; border-radius: 8px; border: 1px solid #EAEAEC; background-color: #222; color: #FAFAFA; font-size: 1rem; cursor: pointer; display: block; text-align: center;">
  ...
  <div id="file-name" style="margin-top: 10px; color: #FAFAFA; font-size: 0.9rem;"></div>
</div>

             
      <div class="sign-submit-btn" style="display: flex; justify-content: center;">
        <button type="submit" style="padding: 10px 20px; background-color: #673C19; color: #FAFAFA; border-radius: 8px; border: none; font-size: 1.2rem; cursor: pointer; width: 100%;">
          Add Product
        </button>
      </div>
    </div>
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-12 color-white"><a href="#">Home</a></li>
                            <li class="mb-12 color-white"><a href="#">Menu</a></li>
                            <li class="mb-12 color-white"><a href="#">Reservation</a></li>
                            <li class="mb-12 color-white"><a href="#">About</a></li>
                            <li class="mb-12 color-white"><a href="#">Shop</a></li>
                        </ul>
                    </div>
                    <div class="footer-link-box v-2">
                        <h6 class="fw-600 color-sec mb-24">Information</h6>
                        <ul class="list-unstyled ">
                            <li class="mb-12 color-white"><a href="#">Contact Us</a></li>
                            <li class="mb-12 color-white"><a href="#">My Account</a></li>
                            <li class="mb-12 color-white"><a href="#">Cart</a></li>
                            <li class="mb-12 color-white"><a href="#">Checkout</a></li>
                        </ul>
                    </div>
