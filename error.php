  ...
  .sign-submit-btn {
    ...
    <body class="tt-smooth-scroll">
      ...
      <div id="scroll-container">
          ...
          <div class="error-wrapper text-center py-40 bg-dark-black br-10">
            <h1 class="color-white mb-32 font-primary">4<span class="color-sec">0</span>1</h1>
            <h5 class="color-white mb-16"><span class="color-primary">Opps!</span> Incorrect login details.</h5>
            <p class="light-gray mb-32">Make sure to double check your password and gmail account.<br> No account yet?
                press the sign up button to create one!</p>
            <a href="signup.php" class="cus-btn primary text-uppercase">Back to Sign up Page</a>
            <a href="login.php" class="cus-btn primary text-uppercase">Back to login Page</a>
