...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/menu.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:18 GMT -->
<head>
    <meta charset="UTF-8">
...
.name-prices {
    display: flex;
    flex-direction: column; /* Stack name, line, and price vertically */
    align-items: center;
    margin-bottom: 8px;
}
...
.center-linez {
    width: 250px; /* Adjust the line length */
    height: 2px;
...
.menu-item {
    width: calc(25% - 10px); /* 4 items per line with some margin */
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Menu</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
       ...
       <section class="menu py-80">
            <div class="container-fluid h-100">
                <div class="d-flex flex-column align-items-center gap-8 text-center mb-48">
                    <h5 class="text-md color-sec text-uppercase">Our Cafe Special Menu</h5>
                ...
                <div class="menu-tabs">	
                    <ul  class="tabs-header unstyled mb-32">
                        <li>
                            <button class="tab-button active" data-toggle="all">
                               ⋆꙳•̩̩͙❅*̩̩͙‧͙ ‧͙*̩̩͙❆ ͙͛ ˚₊⋆Seasonal MENU! ⋆꙳•̩̩͙❅*̩̩͙‧͙ ‧͙*̩̩͙❆ ͙͛ ˚₊⋆
                            </button>
                        </li>
                    </ul>
            ...
            <?php
        include 'connect.php';
        $sql = "SELECT * FROM drinkandpastry";
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                AS average_rating FROM ratings WHERE product_id = $productID"))['average_rating'], 2);

                echo '
                <div class="menu-item">
                    <div class="item-image">
                        <img src="' . $img_name . '" alt="' . $productName . '">
                    </div>
                    <div class="item-detail">
                        <div class="name-prices">
                            <a href="product-detail.php?id=' . $productID . '" class="h6 color-white flex-shrink-0">
                        ' . $productName . '</a>
                            <div class="center-linez"></div>
                
                            <h6 class="color-white flex-shrink-0">$' . number_format($price, 2) . '</h6>
                        </div>
                        <p class="text-16 light-gray">' . $description . '</p>
                         ...
                         <!-- Rating Form -->
                            <form method="POST" action="ratings.php">
                                ...
                                <button type="submit" class="cus-btn primary text-uppercase">Submit Rating</button>
                            </form>
                    </div>
                <div class="col-sm-12">';
        ...
        if (($_SESSION['Role'] == 'Admin' || $_SESSION['Role'] == 'Super Admin')) {
            ...
            echo '
                <a href="edit-product.php?id=' . $productID . '" class="cus-btn primary text-uppercase">Edit</a>
                <a href="deleteD&P.php?id=' . $productID . '" class="cus-btn primary text-uppercase">Delete</a>';
        } else {
            echo '<!-- admin/super admin lng makakakita neto -->';
        }
...
?>
        ...
        <!-- FOOTER START -->
        <footer class="pt-80 pb-40" class="footer-baba">
