...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/shop-list-sidebar.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:31 GMT -->
<head>
    <meta charset="UTF-8">
                            ...
                            <ul class="main-menu__list">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="shop-list-sidebar.php" class="active">Shop List Sidebar</a></li>
                ...
                <div class="row row-gap-4">
                                    ...
                                    <div class="row align-items-center row-gap-3">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="item-detail">
                                                ...
                                                <a href="#" class="h5 color-white mb-8"> 
                                                    CAFFE LATTE
                                                </a>
                                                <p class="text-16 light-gray mb-24">Lorem ipsum dolor sit amet consectetur. Lorem molestie ut sed velit suspendisse pharetra dictum. Nunc lorem est at massa amet sed at elit. Cursus aenean dictumst cursus.</p>
                                    ...
                                    <div class="row align-items-center row-gap-3">
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <div class="item-detail">
                                                ...
                                                <p class="text-16 light-gray mb-24">Lorem ipsum dolor sit amet consectetur. Lorem molestie ut sed velit suspendisse pharetra dictum. Nunc lorem est at massa amet sed at elit. Cursus aenean dictumst cursus.</p>
                                                <div class="d-flex align-items-center justify-content-between">
                                                    <span class="h6 color-white text-decoration-line-through">$20.00 <span class="h6 color-sec">&nbsp; $18.00</span></span>
                                                    <a href="cart.php" class="cus-btn transparent textd-16 p-8-16">
                                                        ADD TO CART
                                                        <i class="far fa-shopping-cart"></i>
                                                    </a>
                    ...
                    <div class="col-xl-3 order-xl-2 order-1">
                        <div class="sidebar bg-dark-black">
                            <form action="https://uiparadox.co.uk/templates/caffe-craze/blog-detail.php" class="mb-24">
