...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:15 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="assets/css/vendor/timePicker.css">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
                            ...
                            <ul class="main-menu__list">
                               ...
                               <li class="dropdown">
                                ...
                                <?php if ($_SESSION['Role'] === 'Admin' || $_SESSION['Role'] === 'Super Admin'): ?>
                                    ...
                                    <ul>
                                        <li><a href="./account.php">Account Deails</a></li>
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Contact Us</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
        ...
        <section class="contact-section py-80">
            <div class="container-fluid">
                <div class="contact-wrapper mb-24">
                    <div class="row row-gap-4">
                        <div class="col-xl-6">
                            <div class="reservation-form form-container bg-dark-black">
                                <form action="https://uiparadox.co.uk/templates/caffe-craze/contact.php" method="post">
                                    <h5 class="text-md color-sec text-uppercase mb-8"><i class="fa-solid fa-dash fw-300"></i> RESERVATION</h5>
                                    <h2 class="color-white font-primary fw-500 mb-24">Book A Table</h2>
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-24">
                                                <input type="tel" name="phone" id="number" class="form-control" placeholder="Phone Number">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-24">
                                                <input type="number" name="number" id="count" class="form-control" placeholder="Number of People">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-24">
                                                <div class="input-arrow mt-24">
                                                    <div class="input-date-picker arrow-down">
                                                        <input type="text" class="sel-input date_from form-control" id="checkIn" placeholder="Date">
                                                    </div>
                                                </div>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <g clip-path="url(#clip0_9688_4075)">
                                                    <path d="M5.84766 9.72656H4.59766C4.27406 9.72656 4.01172 9.98891 4.01172 10.3125C4.01172 10.6361 4.27406 10.8984 4.59766 10.8984H5.84766C6.17125 10.8984 6.43359 10.6361 6.43359 10.3125C6.43359 9.98891 6.17125 9.72656 5.84766 9.72656Z" fill="#FAFAFA"/>
                                                    <path d="M5.84766 12.2266H4.59766C4.27406 12.2266 4.01172 12.4889 4.01172 12.8125C4.01172 13.1361 4.27406 13.3984 4.59766 13.3984H5.84766C6.17125 13.3984 6.43359 13.1361 6.43359 12.8125C6.43359 12.4889 6.17125 12.2266 5.84766 12.2266Z" fill="#FAFAFA"/>
                                                    <path d="M5.84766 14.7266H4.59766C4.27406 14.7266 4.01172 14.9889 4.01172 15.3125C4.01172 15.6361 4.27406 15.8984 4.59766 15.8984H5.84766C6.17125 15.8984 6.43359 15.6361 6.43359 15.3125C6.43359 14.9889 6.17125 14.7266 5.84766 14.7266Z" fill="#FAFAFA"/>
                                                    <path d="M10.8477 9.72656H9.59766C9.27406 9.72656 9.01172 9.98891 9.01172 10.3125C9.01172 10.6361 9.27406 10.8984 9.59766 10.8984H10.8477C11.1713 10.8984 11.4336 10.6361 11.4336 10.3125C11.4336 9.98891 11.1713 9.72656 10.8477 9.72656Z" fill="#FAFAFA"/>
                                                    <path d="M10.8477 12.2266H9.59766C9.27406 12.2266 9.01172 12.4889 9.01172 12.8125C9.01172 13.1361 9.27406 13.3984 9.59766 13.3984H10.8477C11.1713 13.3984 11.4336 13.1361 11.4336 12.8125C11.4336 12.4889 11.1713 12.2266 10.8477 12.2266Z" fill="#FAFAFA"/>
                                                    <path d="M10.8477 14.7266H9.59766C9.27406 14.7266 9.01172 14.9889 9.01172 15.3125C9.01172 15.6361 9.27406 15.8984 9.59766 15.8984H10.8477C11.1713 15.8984 11.4336 15.6361 11.4336 15.3125C11.4336 14.9889 11.1713 14.7266 10.8477 14.7266Z" fill="#FAFAFA"/>
                                                    <path d="M15.8477 9.72656H14.5977C14.2741 9.72656 14.0117 9.98891 14.0117 10.3125C14.0117 10.6361 14.2741 10.8984 14.5977 10.8984H15.8477C16.1713 10.8984 16.4336 10.6361 16.4336 10.3125C16.4336 9.98891 16.1713 9.72656 15.8477 9.72656Z" fill="#FAFAFA"/>
                                                    <path d="M15.8477 12.2266H14.5977C14.2741 12.2266 14.0117 12.4889 14.0117 12.8125C14.0117 13.1361 14.2741 13.3984 14.5977 13.3984H15.8477C16.1713 13.3984 16.4336 13.1361 16.4336 12.8125C16.4336 12.4889 16.1713 12.2266 15.8477 12.2266Z" fill="#FAFAFA"/>
                                                    <path d="M15.8477 14.7266H14.5977C14.2741 14.7266 14.0117 14.9889 14.0117 15.3125C14.0117 15.6361 14.2741 15.8984 14.5977 15.8984H15.8477C16.1713 15.8984 16.4336 15.6361 16.4336 15.3125C16.4336 14.9889 16.1713 14.7266 15.8477 14.7266Z" fill="#FAFAFA"/>
                                                    <path d="M18.4648 2.53906H17.0586V1.5625C17.0586 1.23891 16.7962 0.976562 16.4727 0.976562C16.1491 0.976562 15.8867 1.23891 15.8867 1.5625V2.53906H10.8086V1.5625C10.8086 1.23891 10.5463 0.976562 10.2227 0.976562C9.89906 0.976562 9.63672 1.23891 9.63672 1.5625V2.53906H4.55859V1.5625C4.55859 1.23891 4.29625 0.976562 3.97266 0.976562C3.64906 0.976562 3.38672 1.23891 3.38672 1.5625V2.53906H1.98047C1.01121 2.53906 0.222656 3.32762 0.222656 4.29688V17.2656C0.222656 18.2349 1.01121 19.0234 1.98047 19.0234H18.4648C19.4341 19.0234 20.2227 18.2349 20.2227 17.2656C20.2227 16.8874 20.2227 4.62598 20.2227 4.29688C20.2227 3.32762 19.4341 2.53906 18.4648 2.53906ZM1.39453 4.29688C1.39453 3.97379 1.65738 3.71094 1.98047 3.71094H3.38672V4.6875C3.38672 5.01109 3.64906 5.27344 3.97266 5.27344C4.29625 5.27344 4.55859 5.01109 4.55859 4.6875V3.71094H9.63672V4.6875C9.63672 5.01109 9.89906 5.27344 10.2227 5.27344C10.5463 5.27344 10.8086 5.01109 10.8086 4.6875V3.71094H15.8867V4.6875C15.8867 5.01109 16.1491 5.27344 16.4727 5.27344C16.7962 5.27344 17.0586 5.01109 17.0586 4.6875V3.71094H18.4648C18.7879 3.71094 19.0508 3.97379 19.0508 4.29688V6.60156H1.39453V4.29688ZM18.4648 17.8516H1.98047C1.65738 17.8516 1.39453 17.5887 1.39453 17.2656V7.77344H19.0508V17.2656C19.0508 17.5887 18.7879 17.8516 18.4648 17.8516Z" fill="#FAFAFA"/>
                                                    </g>
                                                    <defs>
                                                    <clipPath id="clip0_9688_4075">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-24">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <g clip-path="url(#clip0_9688_4061)">
                                                    <path d="M9.99991 0.125C4.48595 0.125 0 4.61086 0 10.1247C0 15.639 4.48595 20.125 9.99991 20.125C15.5138 20.125 19.9996 15.6389 19.9996 10.1247C19.9996 4.61086 15.5138 0.125 9.99991 0.125ZM9.99991 18.6915C5.27638 18.6915 1.43349 14.8484 1.43349 10.1247C1.43349 5.40128 5.27638 1.55849 9.99991 1.55849C14.7233 1.55849 18.5661 5.40128 18.5661 10.1247C18.5661 14.8484 14.7233 18.6915 9.99991 18.6915Z" fill="#FAFAFA"/>
                                                    <path d="M15.1417 9.95738H10.4424V4.82053C10.4424 4.42469 10.1216 4.10378 9.72563 4.10378C9.3298 4.10378 9.00889 4.42469 9.00889 4.82053V10.6741C9.00889 11.07 9.3298 11.3909 9.72563 11.3909H15.1417C15.5377 11.3909 15.8585 11.07 15.8585 10.6741C15.8585 10.2783 15.5376 9.95738 15.1417 9.95738Z" fill="#FAFAFA"/>
                                                    </g>
                                                    <defs>
                                                    <clipPath id="clip0_9688_4061">
                                                    <rect width="20" height="20" fill="white"/>
                                                    </clipPath>
                                                    </defs>
                                                </svg>
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="cus-btn primary text-uppercase">Book a table</button>
                                        </div>
                    ...
                    <div class="row row-gap-4">
                        <div class="col-xl-6">
                            <div class="form-container">
                                <form action="https://uiparadox.co.uk/templates/caffe-craze/contact.php" method="post" class="contact-form">
                                    <h5 class="font-primary color-white mb-12">Customer Support</h5>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <button type="submit" class="cus-btn primary text-uppercase">Send Message</button>
                                        </div>
                                        <!-- Alert Message -->
                        ...
                        <div class="col-xl-6">
                            <div class="contact-text-container">
                                <h5 class="font-primary color-white mb-12">How to Reach Us</h5>
                                ...
                                <div class="detail-block mb-24">
                                    ...
                                    <div>
                                        <h6 class="color-white mb-12">Store Location:</h6>
                                ...
                                <div class="detail-block mb-24">
                                    ...
                                    <div>
                                        <h6 class="color-white mb-12">Phone Number:</h6>
                                ...
                                <div class="detail-block mb-24">
                                    ...
                                    <div>
                                        <h6 class="color-white mb-12">Email Address:</h6>
                                        <a href="mailto:info@example.com" class="light-gray">exampleinfo@gmail.com</a>
                                    </div>
                                </div>

                                <h6 class="color-white mb-16">Social Media:</h6>
                                <ul class="list-unstyled social-icon mb-40"> 
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <path
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clip-path="url(#clip0_9688_4037)">
                                                    <path
                                                        d="M7.32109 20.0038C6.07734 20.0038 4.86133 19.5698 3.89766 18.7815C2.63203 17.7464 1.90625 16.2182 1.90625 14.5889C1.90625 13.4022 2.28359 12.2749 2.99727 11.3292C3.68633 10.4163 4.6668 9.7323 5.7582 9.40379C6.73359 9.11004 7.76211 9.59793 8.15 10.5389C8.175 10.5991 8.19688 10.6616 8.21563 10.7233C8.36758 11.228 8.31406 11.7616 8.06484 12.2257C7.81563 12.6897 7.40039 13.0292 6.8957 13.1811C6.28086 13.3663 5.85156 13.9452 5.85156 14.5889C5.85156 15.1034 6.12734 15.5874 6.57148 15.8522C6.8168 15.9987 7.09805 16.0694 7.38516 16.0573C8.17344 16.0237 8.79102 15.3655 8.79102 14.5585V1.99519C8.79102 1.09519 9.38789 0.301832 10.2422 0.0662855C10.3363 0.0401136 10.4332 0.0213636 10.5293 0.0100355C10.7078 -0.0114489 10.8887 -0.00793324 11.0672 0.0194105C11.7477 0.120582 12.334 0.578786 12.598 1.2155C12.6977 1.45574 12.748 1.70964 12.748 1.97019C12.748 3.01433 13.2227 3.98269 14.0504 4.62683C14.6426 5.08777 15.352 5.33308 16.1016 5.33582C16.9066 5.33855 17.6266 5.81863 17.9359 6.55886C18.0711 6.88308 18.1164 7.23933 18.0664 7.58933C17.9277 8.55535 17.0777 9.28113 16.0871 9.28113C16.0836 9.28113 16.0805 9.28113 16.077 9.28113C14.9 9.27527 13.7629 8.99168 12.7363 8.45378V14.5983C12.7363 14.6046 12.7363 14.6108 12.7359 14.6175C12.727 16.2233 12.0113 17.7319 10.7719 18.7589C9.80313 19.5616 8.57773 20.0038 7.32109 20.0038ZM6.3293 10.4909C6.25195 10.4909 6.17344 10.5022 6.0957 10.5257C5.24062 10.7831 4.47227 11.3194 3.93242 12.035C3.37344 12.7757 3.07813 13.6589 3.07813 14.5889C3.07813 15.8651 3.64727 17.0628 4.63984 17.8745C5.39492 18.4921 6.34727 18.8319 7.32109 18.8319C8.30508 18.8319 9.26523 18.4854 10.0238 17.8565C10.9977 17.0495 11.559 15.8647 11.5641 14.6057C11.5641 14.6014 11.5641 14.5964 11.5645 14.5905V6.2448L12.4965 6.92683C13.5445 7.69402 14.7848 8.10261 16.0828 8.10925H16.0871C16.4984 8.10925 16.85 7.81511 16.9062 7.42332C16.9266 7.28035 16.9094 7.14168 16.8547 7.01082C16.7293 6.71121 16.4254 6.50886 16.0977 6.50769C15.0863 6.50418 14.1293 6.17332 13.3309 5.55144C12.216 4.68347 11.5766 3.378 11.5766 1.97019C11.5766 1.86433 11.5562 1.76121 11.516 1.66433C11.4086 1.40535 11.1703 1.21902 10.8945 1.17839L10.8895 1.17761C10.816 1.16629 10.7418 1.16472 10.6684 1.17371C10.6305 1.17839 10.5922 1.18582 10.5543 1.19636C10.2055 1.29207 9.9625 1.62058 9.9625 1.99519V14.5585C9.9625 15.2448 9.70391 15.8983 9.23477 16.3987C8.76055 16.9046 8.12109 17.1991 7.43438 17.228C6.91836 17.2495 6.4125 17.1221 5.9707 16.8585C5.17422 16.3835 4.6793 15.5136 4.6793 14.5889C4.6793 13.4327 5.45156 12.3925 6.55742 12.0593C6.76211 11.9975 6.93086 11.8596 7.03203 11.6714C7.1332 11.4831 7.15508 11.2663 7.09336 11.0616C7.08594 11.0366 7.07656 11.0108 7.06641 10.9858C6.93984 10.6788 6.6457 10.4909 6.3293 10.4909ZM12.7355 14.6081V14.6132C12.7355 14.6116 12.7355 14.6096 12.7355 14.6081Z"
                                                        fill="#E8C895" />
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0_9688_4037">
                                                        <rect width="20" height="20" fill="white" />
                                                    </clipPath>
                                                </defs>
                                            </svg>
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clip-path="url(#clip0_9688_4039)">
                                                    <path
                                    ...
                                    <li>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                <g clip-path="url(#clip0_9688_4041)">
                                                    <path
                                                        d="M11.8694 8.46864L19.1548 0H17.4284L11.1025 7.3532L6.05007 0H0.222656L7.86296 11.1193L0.222656 20H1.94915L8.62943 12.2348L13.9652 20H19.7926L11.869 8.46864H11.8694ZM9.50476 11.2173L8.73064 10.1101L2.57123 1.29967H5.22302L10.1937 8.40994L10.9679 9.51718L17.4292 18.7594H14.7774L9.50476 11.2177V11.2173Z"
                                                        fill="#E8C895" />
                                                </g>
                                                <defs>
                                                    <clipPath id="clip0_9688_4041">
                                                        <rect width="20" height="20" fill="white" />
                                                    </clipPath>
                                                </defs>
                                            </svg>
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled ">
                            ...
                            <li class="mb-12 color-white"><a href="checkout.pgp">Checkout</a></li>
                        </ul>
                    </div>
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/contact.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:18 GMT -->
</html>