  ...
  .sign-submit-btn {
    ...
    <body class="tt-smooth-scroll">
      ...
      <div id="scroll-container">
          ...
          <section class="title-banner text-center">
              <div class="container-fluid">
                  <h1 class="color-white fw-400">Log in</h1>
              </div>
          </section>
    ...
    <section class="my-account py-40">
        <div class="container-fluid">
            <div class="row row-gap-4">
                <div class="col-xl-12">
                    <div class="account account-1">
                        <h5 class="color-white mb-12">Login</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-16">
                                        <input type="text" name="YourEmail" autocomplete="off" class="form-control" required placeholder="Your Email">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-block mb-16">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <g clip-path="url(#clip0_9705_7700)">
                                                <path
                                ...
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="#" class="color-sec fw-400">Forget Password</a>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <input type="submit" class="cus-btn primary text-uppercase" value = "Log in">
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <!-- NEWSLETTER START -->
        <section class="newsletter bg-dark-black" style="width: 100%;">
            <div class="container-fluid">
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled ">
                            ...
                            <li class="mb-12 color-white"><a href="myaccount.php">My Account</a></li>
