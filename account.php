            ...
            <div class="container-fluid">
                <div class="row row-gap-4">
                    <div class="col-xl-12">
                        ...
                        <p style="color: #ad7e40; margin-top: 15px; margin-left: 4%; margin-bottom:2%;">Choose your profile</p>

                                <form action="update.php" method="post">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="text" name="FirstName" id="FirstName" class="form-control" placeholder="New First Name">
                                        ...
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                                                <input type="text" name="LastName" id="LastName" class="form-control" placeholder="New Last Name">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path
                                                        d="M10 0C7.09223 0 4.72656 2.36566 4.72656 5.27344C4.72656 8.18121 7.09223 10.5469 10 10.5469C12.9078 10.5469 15.2734 8.18121 15.2734 5.27344C15.2734 2.36566 12.9078 0 10 0ZM10 9.375C7.7384 9.375 5.89844 7.53504 5.89844 5.27344C5.89844 3.01184 7.7384 1.17188 10 1.17188C12.2616 1.17188 14.1016 3.01184 14.1016 5.27344C14.1016 7.53504 12.2616 9.375 10 9.375Z"
                                                        fill="#FAFAFA" />
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-block mb-16">
                                                <input type="YourEmail" name="YourEmail" autocomplete="off" class="form-control" placeholder=" New Email">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path
                ...
                <div class="col-sm-12">
                <a href="./delete.php" class="cus-btn primary text-uppercase">Delete Account</a> 
