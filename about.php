...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:18 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
                    ...
                    <div class="navigation-wrapper">
                        ...
                        <div class="main-menu__nav">
                            <ul class="main-menu__list">
                                ...
                                <?php if ($_SESSION['Role'] === 'user'): // makikita lng toh IF user ka?> 
                                <li>
                                    <a href="myaccount.php">My Account</a>
                                </li>
                                <?php endif; // pag close ng if?>
                                <?php if ($_SESSION['Role'] === 'Admin' || $_SESSION['Role'] === 'Super Admin'): // naka burger menu which si admin/super admin lng nakakakita?>
                                    <li class="dropdown">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">About Us</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
                ...
                <div class="row align-items-center row-gap-5">
                    <div class="col-lg-6">
                        <div class="about-detail">
                            ...
                            <p class="text-16 light-gray mb-12">Lorem ipsum dolor sit amet consectetur. Est nascetur erat eget ornare eu eget in
                                diam quis. Massa risus commodo turpis malesuada ante nullam hac sit. Blandit est morbi ornare donec. Molestie
                                pellentesque amet ac vel neque purus. Facilisis fusce a volutpat maecenas gravida urna nibh eget id. Pulvinar lacus
                                volutpat netus pellentesque cursus hendrerit. Velit eleifend imperdiet pharetra urna urna nibh placerat. Mauris
                                vulputate tempor eget in vitae.</p>
                            <p class="text-16 light-gray mb-48">Lorem ipsum dolor sit amet consectetur. Est nascetur erat eget ornare eu eget in
                                diam quis. Massa risus commodo turpis malesuada ante nullam hac sit. Blandit est morbi ornare donec. Molestie
                                pellentesque amet ac vel neque purus. Facilisis fusce a volutpat maecenas gravida urna nibh eget id.</p>
