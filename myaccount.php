...
$id = $_SESSION['id'];
$uploadedImagePath = "uploads/";

// Fetch user data, including the profile image
$sql = "SELECT img_name FROM signupusers WHERE id=$id";
$result = mysqli_query($conn, $sql);

if ($row = mysqli_fetch_assoc($result)) {
    $imageFileName = !empty($row['img_name']) ? $row['img_name'] : ''; 
    $_SESSION['profile_image'] = $imageFileName; // Update session to sync
} else {
    ...
    <body class="tt-smooth-scroll">
      ...
      <div id="scroll-container">
                      ...
                      <div class="navigation-wrapper">
                          ...
                          <div class="main-menu__nav">
                              ...
                              <?php if ($_SESSION['Role'] === 'user'): ?>
                                ...
                                <?php elseif ($_SESSION['Role'] === 'Admin' || $_SESSION['Role'] === 'Super Admin'):?>
                                    <li>
          ...
          <section class="title-banner text-center">
              <div class="container-fluid">
                  <h1 class="color-white fw-400">Account</h1>
              </div>
            </section>
     ...
     <div class="account">
                    <div class="col-xl-12" >
                        <h5 class="color-white mb-12">Update your account here</h5>
                     <!--PFP MO PRE DITO -->   
                     <div class="profile-container">              
    <form action="update.php" method="post" enctype="multipart/form-data">
    <label for="fileToUpload">
    <img src="uploads/<?php echo $imageFileName; ?>" class="profile-pic" id="profilePic">
    
</label>    
    <input type="file" name="fileToUpload" id="fileToUpload" style="display: none;" onchange="this.form.submit()">   
    </div>
    <p style="color: #ad7e40; margin-top: 15px; margin-left: 4%;">Choose your profile</p>
                 <div class="account">
                        <div class="account account-1">
                                <form action="update.php" method="post" >
                                    <div class="row">                         
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-block mb-16">
                                                <input type="YourEmail" name="YourEmail" autocomplete="off" class="form-control" placeholder="YourEmail">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path
                                        ...
                                        <a href="passUpdate.php">Update your password here.</a>
                                        </div>
                                        
                                        <div class="col-md-12">
                                            <p class="light-gray mb-24" id>Your personal information helps improve your experience on our site, manage your account, and fulfill other purposes
                                                as detailed in our <span class="color-sec">privacy policy.</span></p>
                                        </div>
                                        <div class="col-sm-12">
                                            <input type="submit" class="cus-btn primary text-uppercase" value="Update"> 
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="col-sm-12">
                    <a href="./disable.php" class="cus-btn primary text-uppercase">Disable Account</a>
                </div>
            </section>
            <!-- NEWSLETTER START -->
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-12 color-white"><a href="index6c56.php">Home</a></li>
