...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:34 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Checkout</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
            ...
            <div class="customer-container py-40">
                <div class="container-fluid">
                    <div class="customer-wrapper">
                        <div class="title-box">
                            <h6 class="color-white fw-500">Returning Customer? <a href="javascript:;" class="color-sec text-decoration-underline signin-button">Click here to login</a></h6>
                        </div>
                        <div class="sign-form mt-48">
                            ...
                            <form action="https://uiparadox.co.uk/templates/caffe-craze/tracking.php" method="post"> 
                                <div class="row row-gap-3">
                                    ...
                                    <div class="col-lg-6">
                                        <button type="submit" class="cus-btn text-uppercase primary">Sign In</button>
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <section class="billing-detail pb-80">
                <div class="container-fluid">
                    <div class="row row-gap-4">
                        <div class="col-xl-8">
                            <h5 class="color-white mb-16 pl-24">Billing Details</h5>
                            <div class="billing-wrapper p-24 bg-dark-black br-10 mb-40">
                                <form action="https://uiparadox.co.uk/templates/caffe-craze/checkout.php" method="post" class="contact-form">
                                    <div class="row">
                                        <div class="col-md-6">
                                ...
                                <form action="https://uiparadox.co.uk/templates/caffe-craze/tracking.php" method="post" class="billing-address contact-form mt-16">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-block mb-16">
                            ...
                            <h5 class="color-white pl-24 mb-12">Shipping Methods</h5>   
                            <div class="shipping-radio-container bg-dark-black mb-40">
                                <div class="plans mb-16">
                                    <label class="plan basic-plan" for="basic">
                                        <input checked type="radio" name="plan" id="basic">
                                        <span class="plan-content">
                                            <img src="assets/media/icon/radio-1.png" alt="">
                                            <span class="plan-details">
                                                <span class="h6 fw-500 color-white">FedEx</span>
                                                <span class="light-gray d-block">Delivery, Tomorrow</span>
                                            </span>
                                            <span class="h6 fw-500 color-white">$1.00</span>
                                        </span>
                                    </label>
                                    <label class="plan basic-plan" for="basic2">
                                        <input type="radio" name="plan" id="basic2">
                                        <span class="plan-content">
                                            <img src="assets/media/icon/radio-2.png" alt="">
                                            <span class="plan-details">
                                                <span class="h6 fw-500 color-white">American</span>
                                                <span class="light-gray d-block">Delivery, Today</span>
                                            </span>
                                            <span class="h6 fw-500 color-white">$5.00</span>
                                        </span>
                                    </label>
                                </div>
                                <div class="plans">
                                    <label class="plan basic-plan" for="basic3">
                                        ...
                                        <span class="plan-content">
                                            <img src="assets/media/icon/radio-3.png" alt="">
                                            <span class="plan-details">
                                                <span class="h6 fw-500 color-white">DHL</span>
                                                <span class="light-gray d-block">Delivery, Today</span>
                                            </span>
                                            <span class="h6 fw-500 color-white">$1.00</span>
                                        </span>
                                    ...
                                    <label class="plan basic-plan" for="basic4">
                                        ...
                                        <span class="plan-content">
                                            <img src="assets/media/icon/radio-4.png" alt="">
                                            <span class="plan-details">
                                                <span class="h6 fw-500 color-white">American</span>
                                                <span class="light-gray d-block">Delivery, Today</span>
                                            </span>
                            ...
                            <!-- Payment Method -->
                            <h5 class="color-white pl-24 mb-12">Payments Methods</h5>   
                            <div class="shipping-radio-container bg-dark-black">
                                <form action="https://uiparadox.co.uk/templates/caffe-craze/tracking.php" method="post">
                                    <div class="plans mb-16">
                                        <label class="plan basic-plan" for="credit">
                                            <input checked type="radio" name="plan" id="credit">
                                            <span class="plan-content content-2">
                                                <img src="assets/media/icon/radio-5.png" alt="">
                                                <span class="plan-details">
                                                    <span class="text-16 fw-400 color-white">Credit or Debit Card</span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="plan basic-plan" for="paypal">
                                            ...
                                            <span class="plan-content content-2">
                                                <img src="assets/media/icon/radio-6.png" alt="">
                                                <span class="plan-details">
                                                    <span class="text-16 fw-400 color-white">Paypal</span>
                                                </span>
                                            </span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="plans mb-40">
                                        <label class="plan basic-plan" for="bank">
                                            ...
                                            <span class="plan-content content-2">
                                                <img src="assets/media/icon/radio-7.png" alt="">
                                                <span class="plan-details">
                                                    <span class="text-16 fw-400 color-white">Direct Bank Transfer </span>
                                                </span>
                                            </span>
                                        </label>
                                        <label class="plan basic-plan" for="cod">
                                            ...
                                            <span class="plan-content content-2">
                                                <img src="assets/media/icon/radio-8.png" alt="">
                                                <span class="plan-details">
                                                    <span class="text-16 fw-400 color-white">Cash on Delivery</span>
                                                </span>
                                            </span>
                                        </label>
                                    </div>
                                ...
                                <h5 class="color-white mb-24">Payments Details</h5>   
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" name="name-card" id="name01" class="form-control" placeholder="Enter Name Card">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                                <path
                                                    d="M10.5 0C7.59223 0 5.22656 2.36566 5.22656 5.27344C5.22656 8.18121 7.59223 10.5469 10.5 10.5469C13.4078 10.5469 15.7734 8.18121 15.7734 5.27344C15.7734 2.36566 13.4078 0 10.5 0ZM10.5 9.375C8.2384 9.375 6.39844 7.53504 6.39844 5.27344C6.39844 3.01184 8.2384 1.17188 10.5 1.17188C12.7616 1.17188 14.6016 3.01184 14.6016 5.27344C14.6016 7.53504 12.7616 9.375 10.5 9.375Z"
                                                    fill="#FAFAFA" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="number" name="card-number" id="cNumber" class="form-control" placeholder="Card Number">
                                            <i class="fa-light fa-credit-card-front"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            <input type="text" class="sel-input date_from form-control" id="checkIn" placeholder="Expiration Date">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-block mb-16">
                                            ...
                                            <i class="fa-regular fa-credit-card-blank"></i>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                        ...
                        <div class="col-xl-4">
                            <div class="title-row title-row-2 mb-16">
                                <h5 class="color-white mb-16">Order Summary</h5>
                            </div>
                            <div class="summary-container bg-dark-black">
                                <div class="item-container mb-16">
                                    <div class="left-box d-flex align-items-center gap-16">
                                        ...
                                        <a href="#" class="h6 color-white">Elite Audio Gear x 1</a>
                                    </div>
                                    <div class="right-box">
                                        <h6 class="color-white">$10.00</h6>
                                    </div>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="item-container mb-32">
                                    <div class="left-box d-flex align-items-center gap-16">
                                        <div class="icon-box">
                                            <img src="assets/media/images/cart-image-2.png" alt="">
                                        </div>
                                        <a href="#" class="h6 color-white">Samsung S21 Ultra x 1</a>
                                    </div>
                                    <div class="right-box">
                                        <h6 class="color-white">$18.00</h6>
                                    </div>
                                </div>
                                
                                <div class="input-block d-flex justify-content-between mb-32">
                                    <input type="text" name="cp-Code" class="form-control" id="codeCp" placeholder="Coupon Code">
                                    <button type="button" class="cus-btn primary">Apply Now</button>
                                </div>

                                <div class="d-flex align-items-center justify-content-between mb-16">
                                    <h6 class="color-white fw-500">Subtotal</h6>
                                    <h6 class="color-white fw-500">$430.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="d-flex align-items-center justify-content-between mb-16">
                                    <h6 class="color-white fw-500">Standard Delivery</h6>
                                    <h6 class="color-white fw-500">$5.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="d-flex align-items-center justify-content-between mb-16">
                                    <h6 class="color-white fw-500">Coupon Discount</h6>
                                    <h6 class="color-white fw-500">-$5.00</h6>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <div class="d-flex align-items-center justify-content-between mb-16">
                                    <h5 class="color-sec">TOTAL</h5>
                                    <h5 class="color-sec">$430.00</h5>
                                </div>
                                <div class="hr-line line-2 mb-16"></div>
                                <p class="light-gray mb-16">
                                    ...
                                    other purposes described in our <span class="color-sec"> privacy policy.</span>
                                </p>
                                <div class="col-md-12">
                ...
                <div class="footer-wrapper mb-40">
                    ...
                    <div class="footer-link-box v-2">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="mb-12 color-white"><a href="shop-grid.[h[">Shop</a></li>
                        </ul>
                    </div>
                    <div class="footer-link-box v-2">
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/checkout.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:36 GMT -->
</html>