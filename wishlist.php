...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/wishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:33 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="tt-smooth-scroll">
    ...
    <div id="scroll-container">
        ...
        <section class="title-banner text-center">
            <div class="container-fluid">
                <h1 class="color-white fw-400">Wishlist</h1>
            </div>
        </section>
        <!-- TITLE BANNER END -->
        ...
        <section class="cart py-80">
            <div class="container-fluid">
                ...
                <div class="d-xl-none d-block">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="cart-item-block mb-32">
                                <div class="img-block mb-16">
                                    <a href="#"><img src="assets/media/images/cart-image-1.png" alt="" class="br-5"></a>
                        ...
                        <div class="col-md-6">
                            <div class="cart-item-block mb-32">
                                <div class="img-block mb-16">
                                    <a href="#"><img src="assets/media/images/cart-image-2.png" class="br-5" alt=""></a>
                                    <a href="#" class="cross"><i class="fal fa-times"></i></a>
                                </div>
                ...
                <div class="table-bottom-row varient-2 bg-dark-black">
                    <h5 class="color-sec py-40 text-end">Total: $80.00</h5>
                    <div class="d-flex justify-content-between flex-wrap gap-16">
                        <div class="d-flex align-items-center gap-16 ">
                            <p class="color-white">Share on:</p>
                            <ul class="list-unstyled social-icon m-0 p-0"> 
                                <li>
                                    <a href="#">
                        ...
                        <div class="d-flex align-items-center gap-16 flex-wrap">
                            ...
                            <a href="cart.php" class="cus-btn primary p-8-16">
                                Add All to Cart
                                <i class="far fa-shopping-cart"></i>
                            </a>
                        </div>
...
<!-- Mirrored from uiparadox.co.uk/templates/caffe-craze/wishlist.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 07:16:34 GMT -->
</html>